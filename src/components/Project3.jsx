  ...
  return (
    <div ref={container}>
      <div className='h-[100vh] max-w-full bg-black flex flex-col justify-end py-5 relative' >
        <div className='proj-container max-w-full h-[100vh] flex items-center justify-center px-5 overfloy-x-hidden max-sm:flex-col max-sm:gap-10 max-sm:justify-center' ref={divRef}>
            ...
            <div className='abtProj flex flex-col max-w-1/2 text-white px-10 gap-5' ref={abtRef} >
                <h1 className='poppins-bold text-8xl text-[#C8A2C8] max-sm:text-[5vw]'>MOQOO</h1>
